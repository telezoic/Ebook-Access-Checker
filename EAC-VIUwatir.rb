...
# Usage:
# ruby EAC-VIUwatir.rb [inputfilelocation] [outputfilelocation]
...
#   access checker result
  ...
  #here we switch out 'celerity' for 'watir' / 'watir-webdriver'
...
b = Watir::Browser.new :phantomjs #calling Watir and PhantomJS - switch this to firefox to drive the real thing
